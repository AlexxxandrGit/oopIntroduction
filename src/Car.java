...
/**
 public void displayingInformationAboutEachMachine() {
 System.out.println(model + " " + brand + productionYear + " год выпуска. Сборка в " + productionCountry +"."+" Кузов " + color + " Объем двигателя - " + engineVolume );
